...
<div class="container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title mb-1">Edit Banner</h1>
                <p class="page-subtitle mb-0">Update banner information</p>
            </div>
                    ...
                    <form action="{{ route('admin.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data" id="editBannerForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('position') is-invalid @enderror" id="position" name="position" required>
                                    ...
                                    <option value="hero" {{ old('position', $banner->display_position) == 'hero' ? 'selected' : '' }}>Hero Section</option>
                                    <option value="sidebar" {{ old('position', $banner->display_position) == 'sidebar' ? 'selected' : '' }}>Sidebar</option>
                                    <option value="footer" {{ old('position', $banner->display_position) == 'footer' ? 'selected' : '' }}>Footer</option>
                                    <option value="popup" {{ old('position', $banner->display_position) == 'popup' ? 'selected' : '' }}>Popup</option>
                                </select>
                                @error('position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" placeholder="Optional banner description">{{ old('description', $banner->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($banner->image)
                            <div class="mb-2">
                                <img src="{{ $banner->image_url }}" alt="Current Banner" class="img-thumbnail" style="max-height: 150px;">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-danger" onclick="deleteBanner({{ $banner->id }})">
